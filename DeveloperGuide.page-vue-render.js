...
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewClientCommandPasrse#parse()")]),_v(" given the arguments succeeding the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view-client")]),_v(" command, parse the appropriate index to ViewClientCommand.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewClientCommand#execute()")]),_v(" given the list of Clients, identify the indexed Client which would be displayed on the ViewClientWindow.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view-client 1")]),_v(" command to view the first person in the Client list.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. Before closing the existing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MATER - View Client")]),_v(" Window, the user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view-client 2")]),_v(" command to view the second person in the Client list.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The following sequence diagram shows how a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view-client")]),_v(" operation goes through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following activity diagram summarizes what happens when a user executes a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view-client")]),_v(" command:")])}
},function anonymous(
) {
